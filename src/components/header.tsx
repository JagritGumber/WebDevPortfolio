...
export function Header() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 mx-auto max-w-7xl w-full border-b border-transparent lg:rounded-full lg:border md:transition-all md:ease-out",
        {
          "bg-background/95 backdrop-blur-md border-border lg:top-4 lg:max-w-5xl md:shadow":
            scrolled && !open,
